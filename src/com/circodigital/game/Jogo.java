...
public class Jogo {
    ...
    private void finalizarJogo(boolean vitoria) {
        ...
        if (vitoria) {
            ...
            System.out.println("E sem perceber, você se encontra de volta ao mosteiro da imagem inicial...\n");

            try { Thread.sleep(2000); } catch (InterruptedException e) {}

            System.out.println("Sem lembranças do que aconteceu..");
            ...
            System.out.println("║             Você está preso no Circo Digital...            ║");
            System.out.println("╚════════════════════════════════════════════════════════════╝");
